...
LOCALITY_DB: dict[str, LocalityData] = {
    ...
    "Chennai|Anna Nagar": LocalityData(
        ...
        land_rate_lo=35000, land_rate_hi=41000,
        apt_rate_lo=16100,   apt_rate_hi=18900,
    ...
    "Chennai|T. Nagar": LocalityData(
        ...
        land_rate_lo=41400, land_rate_hi=48600,
        apt_rate_lo=17900,   apt_rate_hi=21100,
    ...
    "Chennai|Velachery": LocalityData(
        ...
        land_rate_lo=18400, land_rate_hi=21600,
    ...
    "Chennai|Adyar": LocalityData(
        ...
        land_rate_lo=38600, land_rate_hi=45400,
        apt_rate_lo=19800,   apt_rate_hi=23200,
    ...
    "Chennai|Porur": LocalityData(
        ...
        land_rate_lo=14700, land_rate_hi=17300,
    ...
    "Chennai|Perambur": LocalityData(
        ...
        land_rate_lo=11000, land_rate_hi=13000,
        apt_rate_lo=8700,  apt_rate_hi=10300,
    ...
    "Chennai|Chromepet": LocalityData(
        ...
        land_rate_lo=12400, land_rate_hi=14600,
        apt_rate_lo=9700,  apt_rate_hi=11300,
    ...
    "Chennai|Tambaram": LocalityData(
        ...
        land_rate_lo=10100, land_rate_hi=11900,
        apt_rate_lo=8300,  apt_rate_hi=9700,
        guideline_value=5500,
        trend_12m="+12.6%",
        micro_context=(
    ...
    "Chennai|Sholinganallur": LocalityData(
        ...
        land_rate_lo=19300, land_rate_hi=22700,
    ...
    "Chennai|Pallavaram": LocalityData(
        ...
        land_rate_lo=11500, land_rate_hi=13500,
        apt_rate_lo=9200,  apt_rate_hi=10800,
    ...
    "Chennai|Shenoy Nagar": LocalityData(
        ...
        land_rate_lo=32200, land_rate_hi=37800,
        apt_rate_lo=15600,   apt_rate_hi=18400,
