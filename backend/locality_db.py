...
LOCALITY_DB: dict[str, LocalityData] = {
    ...
    "Chennai|Anna Nagar": LocalityData(
        ...
        land_rate_lo=22000, land_rate_hi=28000,
        apt_rate_lo=4500,   apt_rate_hi=5800,
    ...
    "Chennai|T. Nagar": LocalityData(
        ...
        land_rate_lo=28000, land_rate_hi=38000,
        apt_rate_lo=5000,   apt_rate_hi=6500,
    ...
    "Chennai|Velachery": LocalityData(
        ...
        apt_rate_lo=3800,   apt_rate_hi=5000,
        guideline_value=7200,
        trend_12m="+8.8%",
        micro_context=(
    ...
    "Chennai|Adyar": LocalityData(
        ...
        land_rate_lo=25000, land_rate_hi=35000,
        apt_rate_lo=5200,   apt_rate_hi=6800,
        guideline_value=10500,
        trend_12m="+4.8%",
        micro_context=(
    ...
    "Chennai|Porur": LocalityData(
        ...
        apt_rate_lo=3400,  apt_rate_hi=4500,
    ...
    "Chennai|Perambur": LocalityData(
        ...
        apt_rate_lo=2800,  apt_rate_hi=3800,
    ...
    "Chennai|Chromepet": LocalityData(
        ...
        apt_rate_lo=3000,  apt_rate_hi=4200,
        guideline_value=4800,
        trend_12m="+11.3%",
        micro_context=(
    ...
    "Chennai|Tambaram": LocalityData(
        ...
        apt_rate_lo=2700,  apt_rate_hi=3800,
    ...
    "Chennai|Sholinganallur": LocalityData(
        ...
        land_rate_lo=14000, land_rate_hi=20000,
        apt_rate_lo=4200,   apt_rate_hi=5600,
    ...
    "Chennai|Pallavaram": LocalityData(
        ...
        land_rate_lo=7500, land_rate_hi=12000,
        apt_rate_lo=2900,  apt_rate_hi=4000,
        guideline_value=4700,
        trend_12m="+10.8%",
        micro_context=(
    ...
    "Chennai|Shenoy Nagar": LocalityData(
        ...
        land_rate_lo=23000, land_rate_hi=28000,
        apt_rate_lo=5500,   apt_rate_hi=7000,
        guideline_value=9800,
        trend_12m="+5.5%",
        micro_context=(
    ...
    "Bangalore|Koramangala": LocalityData(
        ...
        land_rate_lo=30000, land_rate_hi=45000,
        apt_rate_lo=6000,   apt_rate_hi=8000,
    ...
    "Bangalore|Whitefield": LocalityData(
        ...
        apt_rate_lo=5000,   apt_rate_hi=7000,
    ...
    "Bangalore|Indiranagar": LocalityData(
        ...
        land_rate_lo=32000, land_rate_hi=48000,
        apt_rate_lo=6500,   apt_rate_hi=8500,
    ...
    "Bangalore|HSR Layout": LocalityData(
        ...
        land_rate_lo=22000, land_rate_hi=32000,
        apt_rate_lo=5500,   apt_rate_hi=7200,
        guideline_value=9800,
        trend_12m="+10.9%",
        micro_context=(
    ...
    "Bangalore|Marathahalli": LocalityData(
        ...
        land_rate_lo=14000, land_rate_hi=22000,
        apt_rate_lo=4500,   apt_rate_hi=6000,
    ...
    "Bangalore|Electronic City": LocalityData(
        ...
        apt_rate_lo=3500,   apt_rate_hi=5000,
    ...
    "Bangalore|Whitefield": LocalityData(
        ...
        micro_context=(
            "Whitefield is Bangalore's premier IT corridor destination, home to ITPB, "
            "Bagmane Tech Park, and dozens of MNC campuses. The Metro connection has "
            "significantly accelerated value growth, making it one of the fastest-appreciating "
            "localities in South India."
        ),
        infra_notes=(
            "Whitefield Metro Station (Purple Line extension). ITPB, Bagmane Tech Park. "
            "Phoenix Marketcity Mall. Strong developer activity: Prestige, Brigade, Sobha."
        ),
        data_confidence=88,
        demand_drivers=["IT park density", "Metro connectivity", "Premium developer supply", "NRI demand"],
        risk_factors=["Traffic on Old Madras Road", "Flooding in low-lying areas", "Supply overhang risk"],
    ),
}
