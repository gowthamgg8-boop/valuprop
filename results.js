 ...
 *
 * NEW LOCALITIES (May 2026): rates are best-guess estimates anchored to
...
const PRICE_DB = {
  Chennai: {
    ...
    'Anna Nagar West':  {apt:[38,58],  house:[160,240], villa:[270,405], land:[70,105],  trend:'+8.0%', sqft:4100},
    ...
    'Egmore':           {apt:[55,85],  house:[300,450], villa:[480,720], land:[115,170], trend:'+5.0%', sqft:5100},
    'Triplicane':       {apt:[42,65],  house:[200,300], villa:[330,495], land:[80,120],  trend:'+5.2%', sqft:3800},
    'Royapettah':       {apt:[48,75],  house:[240,360], villa:[400,600], land:[100,150], trend:'+5.5%', sqft:4500},
    'Alwarpet':         {apt:[80,128], house:[460,680], villa:[720,1080],land:[170,255], trend:'+4.5%', sqft:6800},
    'Mylapore':         {apt:[55,85],  house:[290,440], villa:[480,720], land:[115,175], trend:'+5.0%', sqft:5100},
    'Teynampet':        {apt:[75,118], house:[420,630], villa:[660,990], land:[155,235], trend:'+4.8%', sqft:6200},
    'R.A. Puram':       {apt:[78,122], house:[440,660], villa:[700,1050],land:[165,245], trend:'+5.0%', sqft:6500},
    'Boat Club Road':   {apt:[120,200],house:[700,1100],villa:[1200,1800],land:[280,420],trend:'+3.5%', sqft:11000},
    // ── South / Coastal ─────────────────────────────────────
    'Adyar':            {apt:[60,95],  house:[310,470], villa:[520,780], land:[120,180], trend:'+4.8%', sqft:5400},
    'Kotturpuram':      {apt:[70,108], house:[360,540], villa:[600,900], land:[140,210], trend:'+5.0%', sqft:5900},
    'Saidapet':         {apt:[42,66],  house:[195,290], villa:[330,495], land:[80,120],  trend:'+5.5%', sqft:4000},
    'Thiruvanmiyur':    {apt:[55,88],  house:[280,420], villa:[470,705], land:[110,165], trend:'+5.8%', sqft:5000},
    'Besant Nagar':     {apt:[68,105], house:[350,525], villa:[580,870], land:[135,205], trend:'+5.2%', sqft:5700},
    'Velachery':        {apt:[38,60],  house:[160,240], villa:[280,420], land:[70,105],  trend:'+8.8%', sqft:4100},
    // ── IT Corridor / OMR ───────────────────────────────────
    'Perungudi':        {apt:[42,66],  house:[180,270], villa:[300,450], land:[78,117],  trend:'+9.4%', sqft:4300},
    'Thoraipakkam':     {apt:[44,70],  house:[185,278], villa:[315,470], land:[80,120],  trend:'+9.8%', sqft:4400},
    'Karapakkam':       {apt:[40,62],  house:[170,255], villa:[290,435], land:[72,108],  trend:'+10.5%',sqft:4000},
    'Sholinganallur':   {apt:[44,68],  house:[185,278], villa:[310,465], land:[80,120],  trend:'+9.4%', sqft:4400},
    'Navalur':          {apt:[34,55],  house:[140,210], villa:[245,365], land:[58,87],   trend:'+11.5%',sqft:3500},
    'Siruseri':         {apt:[36,57],  house:[145,218], villa:[255,380], land:[62,93],   trend:'+11.8%',sqft:3700},
    'Kelambakkam':      {apt:[28,46],  house:[110,165], villa:[195,290], land:[48,72],   trend:'+13.0%',sqft:3000},
    'Pallikaranai':     {apt:[35,56],  house:[150,225], villa:[260,390], land:[64,96],   trend:'+11.0%',sqft:3700},
    'Medavakkam':       {apt:[32,52],  house:[135,200], villa:[235,350], land:[58,87],   trend:'+11.5%',sqft:3400},
    // ── West / Porur belt ───────────────────────────────────
    'Porur':            {apt:[32,52],  house:[120,180], villa:[200,300], land:[55,82],   trend:'+10.2%',sqft:3700},
    'Manapakkam':       {apt:[30,48],  house:[115,170], villa:[195,290], land:[52,78],   trend:'+10.8%',sqft:3500},
    'Iyyappanthangal':  {apt:[28,45],  house:[105,158], villa:[180,270], land:[48,72],   trend:'+11.5%',sqft:3300},
    'Vadapalani':       {apt:[45,70],  house:[210,315], villa:[360,540], land:[88,132],  trend:'+6.5%', sqft:4500},
    'K.K. Nagar':       {apt:[48,75],  house:[235,350], villa:[400,600], land:[98,147],  trend:'+6.2%', sqft:4700},
    'Ashok Nagar':      {apt:[46,72],  house:[225,335], villa:[380,570], land:[94,141],  trend:'+6.5%', sqft:4600},
    ...
    'Padi':             {apt:[28,45],  house:[110,165], villa:[190,285], land:[50,75],   trend:'+10.8%',sqft:3400},
    'Korattur':         {apt:[26,42],  house:[100,150], villa:[180,270], land:[46,69],   trend:'+11.5%',sqft:3200},
    'Ambattur':         {apt:[24,40],  house:[92,138],  villa:[165,250], land:[42,63],   trend:'+12.0%',sqft:3000},
    'Avadi':            {apt:[20,34],  house:[78,118],  villa:[140,210], land:[36,54],   trend:'+13.5%',sqft:2600},
    ...
    'Selaiyur':         {apt:[25,42],  house:[95,142],  villa:[170,255], land:[42,63],   trend:'+12.0%',sqft:3200},
    'Madambakkam':      {apt:[23,38],  house:[88,132],  villa:[158,235], land:[40,60],   trend:'+12.5%',sqft:3000},
    'Urapakkam':        {apt:[20,34],  house:[78,118],  villa:[140,210], land:[36,54],   trend:'+13.5%',sqft:2700},
    'Vandalur':         {apt:[21,35],  house:[80,120],  villa:[145,218], land:[37,55],   trend:'+13.2%',sqft:2800},
    'Guduvanchery':     {apt:[19,32],  house:[74,110],  villa:[135,200], land:[34,51],   trend:'+14.0%',sqft:2600},
    'Maraimalai Nagar': {apt:[18,30],  house:[70,105],  villa:[125,190], land:[32,48],   trend:'+14.5%',sqft:2400},
  },
  Bangalore: {
    // ── Central / Premium ───────────────────────────────────
    ...
    'Sadashivanagar':   {apt:[110,170],house:[620,930], villa:[1050,1575],land:[250,375],trend:'+5.5%', sqft:9500},
    'Malleshwaram':     {apt:[68,108], house:[380,570], villa:[640,960], land:[155,235], trend:'+6.8%', sqft:5900},
    'Rajajinagar':      {apt:[55,86],  house:[300,450], villa:[510,765], land:[125,188], trend:'+7.2%', sqft:4900},
    'Frazer Town':      {apt:[75,118], house:[410,615], villa:[700,1050],land:[170,255], trend:'+6.5%', sqft:6400},
    'Cooke Town':       {apt:[78,122], house:[430,645], villa:[730,1095],land:[175,265], trend:'+6.5%', sqft:6600},
    'Richmond Town':    {apt:[95,150], house:[540,810], villa:[920,1380],land:[220,330], trend:'+5.5%', sqft:8400},
    'Lavelle Road':     {apt:[110,170],house:[620,930], villa:[1050,1575],land:[250,375],trend:'+5.0%', sqft:9800},
    'Basavanagudi':     {apt:[65,102], house:[355,535], villa:[600,900], land:[145,220], trend:'+6.8%', sqft:5500},
    // ── South ───────────────────────────────────────────────
    'JP Nagar':         {apt:[58,92],  house:[290,435], villa:[500,750], land:[125,188], trend:'+7.8%', sqft:5100},
    ...
    'Bannerghatta Road':{apt:[44,72],  house:[200,300], villa:[350,525], land:[92,138],  trend:'+11.5%',sqft:4500},
    'Bommanahalli':     {apt:[40,65],  house:[180,270], villa:[310,465], land:[82,123],  trend:'+12.0%',sqft:4200},
    'Begur':            {apt:[36,58],  house:[160,240], villa:[280,420], land:[74,111],  trend:'+12.8%',sqft:3800},
    'Hulimavu':         {apt:[38,62],  house:[170,255], villa:[300,450], land:[78,117],  trend:'+12.0%',sqft:4000},
    'Banashankari':     {apt:[50,80],  house:[235,353], villa:[410,615], land:[105,158], trend:'+9.0%', sqft:4700},
    'Vijayanagar':      {apt:[46,74],  house:[215,323], villa:[375,565], land:[96,144],  trend:'+8.5%', sqft:4400},
    // ── East / IT Belt ──────────────────────────────────────
    ...
    'Sarjapur Road':    {apt:[52,84],  house:[240,360], villa:[420,630], land:[112,168], trend:'+12.5%',sqft:5300},
    'Bellandur':        {apt:[55,88],  house:[255,383], villa:[440,660], land:[118,177], trend:'+12.0%',sqft:5500},
    'Doddanekundi':     {apt:[48,76],  house:[215,323], villa:[375,565], land:[100,150], trend:'+13.0%',sqft:4900},
    'Mahadevapura':     {apt:[50,80],  house:[225,338], villa:[395,593], land:[105,158], trend:'+12.5%',sqft:5100},
    'ITPL Main Road':   {apt:[54,86],  house:[245,368], villa:[425,638], land:[115,173], trend:'+12.0%',sqft:5400},
    'KR Puram':         {apt:[42,68],  house:[190,285], villa:[330,495], land:[88,132],  trend:'+13.5%',sqft:4400},
    // ── North ───────────────────────────────────────────────
    ...
    'Devanahalli':      {apt:[32,52],  house:[140,210], villa:[245,365], land:[68,102],  trend:'+15.5%',sqft:3500},
    'Hennur':           {apt:[42,68],  house:[195,290], villa:[340,510], land:[90,135],  trend:'+13.2%',sqft:4500},
    'Banaswadi':        {apt:[44,70],  house:[205,308], villa:[358,538], land:[94,141],  trend:'+12.5%',sqft:4600},
    // ── South Periphery ────────────────────────────────────
...
const LOCALITY_TIER = {
  ...
  'Besant Nagar':'premium', 'Egmore':'premium', 'Royapettah':'premium',
  // Chennai — established
  ...
  'Urapakkam':'peripheral', 'Vandalur':'peripheral', 'Guduvanchery':'peripheral',
...
/* ─── Locality lookup (Set 2 #6 — works for free-text input) ─── */
function lookupLocality(city, locality) {
  // Try exact match first
  if (PRICE_DB[city] && PRICE_DB[city][locality]) {
    return { db: PRICE_DB[city][locality], matched: locality };
  }
  // Try case-insensitive partial match — handles free-text variations like
  // 'anna nagar' vs 'Anna Nagar' or 'porur chennai' vs 'Porur'
  if (PRICE_DB[city] && locality) {
    const needle = locality.toLowerCase().trim();
    for (const key of Object.keys(PRICE_DB[city])) {
      if (key.toLowerCase() === needle || key.toLowerCase().includes(needle) || needle.includes(key.toLowerCase())) {
        return { db: PRICE_DB[city][key], matched: key };
      }
    }
  }
  // No match — return null so caller can use a city-level default
  return null;
}
...
function renderStatic(search) {
  ...
  const hit  = lookupLocality(city, loc);
  // Default fallback: median locality for the city, not always Anna Nagar
  const fallback = PRICE_DB[city] && PRICE_DB[city]['Anna Nagar']
                 ? PRICE_DB[city]['Anna Nagar']
                 : PRICE_DB.Chennai['Anna Nagar'];
  const db = hit ? hit.db : fallback;
...
function renderPreview(search) {
  ...
  const loc  = search.locality || 'Anna Nagar';
  const hit  = lookupLocality(city, loc);
  // Same fallback strategy as renderStatic
  const fallback = PRICE_DB[city] && PRICE_DB[city]['Anna Nagar']
                 ? PRICE_DB[city]['Anna Nagar']
                 : PRICE_DB.Chennai['Anna Nagar'];
  const db   = hit ? hit.db : fallback;
  const matchedLoc = hit ? hit.matched : loc;
  const tier = LOCALITY_TIER[matchedLoc] || 'established';

  renderSectionA(search, db);
  renderSectionB(search, db, tier, matchedLoc, city);
  renderSectionC(search, db, matchedLoc);
